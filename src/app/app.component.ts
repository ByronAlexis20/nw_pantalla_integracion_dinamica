...
export class AppComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    let usertemporal = {
      ...
      localStorage.setItem("usuarioIntegrador",JSON.stringify(usertemporal))
      ...
      if(usuTemp&&plaTemp){
        ...
        this._http.get(url).subscribe(data => {
          ...
          if(data["estado"]==="ok"){
            ...
            this._http.get(this.urlValidacion+'/auth/listarPermisos/'+usuTemp+'/'+plaTemp).subscribe(
            dataP => {
              ...
              localStorage.setItem('usuarioIntegrador', JSON.stringify(tempUser));
              this._router.navigate(['/dashboard/ecommerce']);
            },
            error =>{
              tempUser.procesos = [];
